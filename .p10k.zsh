# Generated by Powerlevel10k configuration wizard on 2020-11-05 at 15:58 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=30
  ...
  #typeset -g POWERLEVEL9K_DIR_PREFIX='⟪'
  #typeset -g POWERLEVEL9K_DIR_SUFFIX='⟫'
  typeset -g POWERLEVEL9K_DIR_PREFIX='%B['
  typeset -g POWERLEVEL9K_DIR_SUFFIX='%B]'
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(wgpia0|gpd|wg|(.*tun))[0-9]*'
